...
<section class="page-hero" style="padding-bottom:0">
  ...
  <div class="wrap-narrow article-head">
    ...
    {chips(a['cat'])}
    <h1>{esc(a['title'])}</h1>
    <div class="article-meta"><span>By CryptoStackHub Research</span><span>·</span><span>{a['date']}</span><span>·</span><span>{a['read']} read</span></div>
  </div>
</section>
...
def main():
    ...
    # sitemap + robots
    urls = ["/", "/search/", "/about/", "/contact/", "/write-for-us/", "/advertise/",
            "/privacy-policy/", "/terms/", "/disclaimer/", "/resources/", "/glossary/"]
    urls += [f"/{c['slug']}/" for c in CATS.values()]
    urls += [f"/articles/{a['slug']}/" for a in ARTICLES]
    sm = '<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n'
    sm += "\n".join(f"  <url><loc>https://cryptostackhub.com{u}</loc></url>" for u in urls)
    sm += "\n</urlset>\n"
